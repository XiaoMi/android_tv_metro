...
public class MineView extends RelativeLayout implements ImageChangedListener {
    ...
    public void bindLogoPhoto(String url){
        ...
        if(!TextUtils.isEmpty(url)){
            VolleyHelper.getInstance(getContext()).getImageLoader().get(url, ImageLoader.getImageListener(mActionView, R.drawable.account_photo_normal, R.drawable.account_photo_normal));
        }
    }
